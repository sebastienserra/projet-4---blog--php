...
?>
  ...
  <div class="present">
    <p><?php echo nl2br(($donnees['article']));?></p>
      ...
      <a href="./controllers/frontend/comment_form_controler.php?post_comment=<?php echo $donnees['id']; ?>" class="btn btn-primary btn-sm">
        <span class="far fa-comments"></span>
      </a>
    

      <a href="./controllers/frontend/comments_controler.php?billet=<?php echo $donnees['id']; ?>"class="btn btn-primary btn-sm">
        <span class="far fa-comments"></span>
      </a>
  </div>
<?php
