<form action="../../models/frontend/comment_form_model.php" method="post">
	<div class="form-group">
	<p><input type="text" name="post_comment" value="<?php echo $_GET['post_comment']; ?>" class="form-control"></p>
	</div>
	<div class="form-group">
